...
function flex.process_tags(o)
    ...
    if o.object.tags["Address"] ~= nil then
      o.object.tags["addr"] = o.object.tags["Address"]
      o.object.tags["Address"] = nil
    end

    if o.object.tags["City"] ~= nil then
      o.object.tags["addr:city"] = o.object.tags["City"]
      o.object.tags["City"] = nil
    end

    if o.object.tags["State"] ~= nil then
      o.object.tags["addr:state"] = o.object.tags["State"]
      o.object.tags["State"] = nil
    end

    if o.object.tags["Type_AR"] ~= nil then
      o.object.tags["name:type:ar"] = o.object.tags["Type_AR"]
      o.object.tags["Type_AR"] = nil
    end

    if o.object.tags["Type_EN"] ~= nil then
      o.object.tags["name:type:en"] = o.object.tags["Type_EN"]
      o.object.tags["Type_EN"] = nil
    end

    if o.object.tags["zone"] ~= nil then
      o.object.tags["name:zone"] = o.object.tags["zone"]
      o.object.tags["zone"] = nil
    end
